...
enum NotchVisibility: String, CaseIterable, Identifiable {
    /// Pinned open. The items are always on screen.
    case alwaysShow
    ...
    var explanation: String {
        switch self {
        case .alwaysShow:
            return "The notch stays open with every item visible."
        case .onHover:
        ...
        case .hidden:
            ...
            return "Nothing on screen. Open Drawer again from Applications "
